...
def emit_turn(langfuse: Langfuse, session_id: str, turn_num: int, turn: Turn, transcript_path: Path, host_meta: Optional[Dict[str, str]] = None) -> None:
...
def main() -> int:
    ...
    # Build host metadata for traces
    try:
    ...
    try:
        with FileLock(LOCK_FILE):
            ...
            for t in turns:
                ...
                try:
                    emit_turn(langfuse, session_id, turn_num, t, transcript_path, host_meta)
                except Exception as e:
